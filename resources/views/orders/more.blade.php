        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr class="featurette-divider">
                    <div class="row">
                        <div class="col-sm-1 mt-2 mb-2">Город: <br>
                            {{$cart-> city}}
                        </div>
                        <div class="col-sm-1 mt-2 mb-2">Улица: <br>
                            {{$cart-> street}}
                        </div>
                        <div class="col-sm-1 mt-2 mb-2">Дом: <br>
                            {{$cart-> house}}
                        </div>
                        <div class="col-sm-1 mt-2 mb-2">Корпус: <br>
                            {{$cart->frame}}
                        </div>
                        <div class="col-sm-1 mt-2 mb-2">Квартира: <br>
                            {{$cart->apartment}}
                        </div>
                        <div class="col-sm-1 mt-2 mb-2">Подъезд: <br>
                            {{$cart->entrance}}
                        </div>
                        <div class="col-sm-1 mt-2 mb-2">Этаж: <br>
                            {{$cart-> floor}}
                        </div>
                        <div class="col-sm-1 mt-2 mb-2">Домофон: <br>
                            {{$cart-> intercom}}
                        </div>
                        <div class="col-sm-4 mt-2 mb-2">Комментарий: <br>
                            {{$cart-> comment}}
                        </div>
                    </div>
                </div>
