...
<div class="container mt-5 mb-5">
    ...
    <div class="row">
        <div class="col-sm-4">
            <a href="{{ route ('orders') }}" class="alert-link">Все заказы</a>
        </div>
        <div class="col-sm-4">
            <a href="{{ route ('ordersWork') }}" class="alert-link">В работе</a>
        </div>
        <div class="col-sm-4">
            <a href="{{ route ('ordersDone') }}" class="alert-link">Выполненые</a>
        </div>
    </div>
    <ul class="list1a">
        ...
        <li>
            <div class="row">
                ...
                <div class="col-sm-1 mt-2 mb-2">
                    <a href="{{ route ('ordersMore', $cart->id) }}"><button type="button" class="btn btn-primary">Подробнее</button></a>
                </div>
            </div>
        </li>
        @endforeach
